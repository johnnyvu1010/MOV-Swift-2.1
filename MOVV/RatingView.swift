...
public class RatingView: UIView {
    ...
    func customInit() {
        ...
        if offImage == nil {
            offImage = UIImage(named: "starEmptyGrey", inBundle: bundle, compatibleWithTraitCollection: self.traitCollection)
        }
        if onImage == nil {
            onImage = UIImage(named: "starFilled", inBundle: bundle, compatibleWithTraitCollection: self.traitCollection)
        }
